  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Align(
        ...
        child: Padding(
        padding: const EdgeInsets.only(bottom: 270.0), // Ajusta el espacio superior
        child: Form(
          key: _formKey,
          child: Container(
            ...
            children: <Widget>[
              TextFormField(
                ...
                labelText: 'NOMBRE', // Este es el label que aparecerá
                border: OutlineInputBorder(), // Añade un borde alrededor del campo de texto
                ),
                validator: (value){
              ...
              const SizedBox(height: 10,),
               TextFormField(
                  decoration: const InputDecoration(
                  labelText: 'NUMERO DE CEDULA', // Este es el label que aparecerá
